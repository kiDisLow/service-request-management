    ...
    class DeaCustDAL
    {
        ...
        public bool Insert(DeaCustBLL dc)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO tbl_dea_cust (type, name, email, contact, address, added_date, nquery) VALUES (@type, @name, @email, @contact, @address, @added_date, @nquery)";
                ...
                cmd.Parameters.AddWithValue("@added_by", dc.nquery);
        ...
        public bool Update(DeaCustBLL dc)
        {
            ...
            try
            {
                ...
                string sql = "UPDATE tbl_dea_cust SET type=@type, name=@name, email=@email, contact=@contact, address=@address, added_date=@added_date, nquery=@nquery WHERE id=@id";
